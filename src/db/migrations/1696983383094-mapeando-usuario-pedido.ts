...
export class mapeandoUsuarioPedido1696983383094 implements MigrationInterface {
  name = 'mapeandoUsuarioPedido1696983383094';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "produtos" DROP COLUMN "userId"`);
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "produtos" ADD "userId" character varying(100) NOT NULL`,
    );
